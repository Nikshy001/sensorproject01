...
class DataTransformationConfig:
    ...
    transformed_train_file_path = os.pat.join(artifact_dir,'train.npy')
...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        ...
        logging.info("Entered initiated_data transformation method of data_ingestion class")
        ...
        try:
            ...
            train_arr = np.c[X_test_scaled,np.aray(y_train)]
